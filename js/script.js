...
function mobile_nav_handlers_init() {
  jQuery("header nav .inner-nav.mobile_nav .button_open").on(
    "click",
    function (e) {
      var el = jQuery(this);
        ...
        function () {
          ...
          next_nav_level.css({
            "margin-top":
              window.mobile_nav.animation_params.vertical_end + "px",
            right:
              "-" + window.mobile_nav.animation_params.horizontal_end + "px",
            opacity: 0,
          });
